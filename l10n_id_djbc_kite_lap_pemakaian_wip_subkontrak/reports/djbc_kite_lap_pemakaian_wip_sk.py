...
class LapKitePemakaianWipSk(models.Model):
    _name = "l10n_id.lap_kite_pemakaian_wip_sk"
    _description = "Laporan Pemakaian WIP Subkontrak Untuk KITE"
    _auto = False
    ...
    def _get_movement_type(self, cr):
        query = """
            ...
            FROM  ir_model_data
            WHERE
            module = 'l10n_id_djbc_kite_lap_pemakaian_wip_subkontrak' AND
            name = 'djbc_kite_movement_type_pemakaian_wip_sk'
        """
        cr.execute(query)
        ...
        join_str = """
            ...
            JOIN (
                ...
                WHERE
                    ...
                    (e1.name = 'product_categ_kite_wip')
                ) as h ON
                g.id = h.res_id
        """
        return join_str
