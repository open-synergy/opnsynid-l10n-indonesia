...
class ReturPajakKeluaran(models.Model):
    _name = "l10n_id.retur_pajak_keluaran"
    _description = "Retur Pajak Keluaran"
    ...
    reference_ids = fields.Many2many(
        ...
        comodel_name="account.move",
        relation="rel_rp_keluaran_2_move",
        column1="rp_keluaran_id",
        column2="move_id",
    )
    all_reference_ids = fields.Many2many(
        string="Doc. References",
        comodel_name="account.move",
        relation="rel_rp_keluaran_2_all_move",
    ...
    substitute_id = fields.Many2one(
        ...
        comodel_name="l10n_id.retur_pajak_keluaran",
    )
